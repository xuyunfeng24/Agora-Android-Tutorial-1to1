...
public class VideoChatViewActivity extends AppCompatActivity {
    ...
    private ImageView mMuteBtn,btn_lu;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        srHelper.onActivityResult(this, requestCode, resultCode, data, new ScreenRecorderHelper.OnRecordStatusChangeListener() {
            ...
            public void onChangeSuccess() {
                //开始录制，处理开始录制后的事件
                Toast.makeText(VideoChatViewActivity.this, "开始录制"+srHelper.getRecordFilePath(), Toast.LENGTH_SHORT).show();
            ...
            public void onChangeFailed() {
                //如果录制失败，则不作任何变化
                Toast.makeText(VideoChatViewActivity.this, "如果录制失败"+srHelper.getRecordFilePath(), Toast.LENGTH_SHORT).show();
    ...
    private void initUI() {
        ...
        btn_lu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (flag==1){
                    flag=2;
                    srHelper.startRecord(VideoChatViewActivity.this);
                }else{
                    srHelper.stopRecord(new ScreenRecorderHelper.OnRecordStatusChangeListener() {
                        @Override
                        public void onChangeSuccess() {
                            //当停止成功，做界面变化
                            Toast.makeText(VideoChatViewActivity.this, "录屏成功"+srHelper.getRecordFilePath(), Toast.LENGTH_SHORT).show();
                            Log.e("recored","录屏成功"+srHelper.getRecordFilePath());
                        }

                        @Override
                        public void onChangeFailed() {
                            //不作处理
                            Toast.makeText(VideoChatViewActivity.this, "录屏失败"+srHelper.getRecordFilePath(), Toast.LENGTH_SHORT).show();
                            Log.e("recored","录屏失败"+srHelper.getRecordFilePath());
                        }
                    });
                }
    ...
    private void showSampleLogs() {
        ...
        mLogView.logE("You can also use this to show errors");  //qq1623216272  m1m23456987
    }
    ...
    public void folder(View view) {
        startActivity(new Intent(this,VideoFolderActivity.class));
    }
